...
- [x] `api/models.py` completely rewritten with learning platform models
- [x] `core/database.py` creates all tables on startup
- [x] Default admin user created if not exists
- [x] `main.py` calls `init_db()` at startup
- [x] All Pydantic models match the new domain
- [x] Quiz, attempt, and progress models properly linked
- [x] Audit log table for compliance
- [x] File uploads metadata table
- [x] No remaining IT-ticket references in models
