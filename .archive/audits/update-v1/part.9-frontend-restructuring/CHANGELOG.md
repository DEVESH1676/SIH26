...
- [x] `package.json` updated with i18n, react-dropzone, recharts
- [x] `i18n.ts` multi-language configuration
- [x] `useAuthStore.ts` Zustand auth store
- [x] `useAnalyticsStore.ts` analytics data store
- [x] `App.tsx` with route-based layout
- [x] `MainLayout.tsx` role-aware sidebar
- [x] `Dashboard.tsx` learner dashboard with stats
- [x] `Courses.tsx` course catalog with filters
- [x] `FileUpload.tsx` drag-and-drop upload
- [x] `VirtualAssistant.tsx` floating chat widget
- [x] `Analytics.tsx` real data analytics page
